...
import {RoleAuthorityHarness, V2TestBase} from "./V2TestBase.sol";

contract V2DecayingTokenTest is V2TestBase {
...
contract DecayingTokenHandler is V2TestBase {
...
contract V2DecayingTokenInvariantTest is V2TestBase {
    VillagePresenceToken internal token;
